      ...
      <Popover className="relative">
        {({ open, close }) => (
          <>
            ...
            >
              <PopoverPanel className="absolute z-10 w-screen max-w-[260px] px-2 mt-3.5 -right-10 sm:right-0 sm:px-0">
                <div className="overflow-hidden rounded shadow-xl ring-1 ring-black ring-opacity-5">
                  <div className="relative grid grid-cols-1 gap-6 bg-white dark:bg-neutral-800 py-5 px-5">
                    <div className="flex items-center space-x-3">
                      <Avatar imgUrl={avatarImgs[7]} sizeClass="w-10 h-10" />
                    ...
                    <Link
                      href={"/account"}
                      className="flex items-center p-2 -m-3 transition  duration-150 ease-in-out rounded hover:bg-neutral-100 dark:hover:bg-neutral-700 focus:outline-none focus-visible:ring focus-visible:ring-orange-500 focus-visible:ring-opacity-50"
                      onClick={() => close()}
                    >
                    ...
                    >
                      ...
                      <div className="ml-4">
                        <p className="text-xs font-medium ">{"My Order"}</p>
                      </div>
                    </Link>
                    ...
                    {/* ------------------ 2 --------------------- */}
                    <div className="flex items-center justify-between p-2 -m-3 transition duration-150 ease-in-out rounded hover:bg-neutral-100 dark:hover:bg-neutral-700 focus:outline-none focus-visible:ring focus-visible:ring-orange-500 focus-visible:ring-opacity-50">
                      <div className="flex items-center">
                        ...
                        <div className="ml-4">
                          <p className="text-xs font-medium ">{"Dark theme"}</p>
                        </div>
                      </div>
                      <SwitchDarkMode2 />
                    </div>

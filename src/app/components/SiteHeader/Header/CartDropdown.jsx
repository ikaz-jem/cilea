      ...
      <div key={index} className="flex py-4 last:pb-0">
        ...
        <div className="ml-4 flex flex-1 flex-col">
          ...
          <div className="flex flex-1 items-end justify-between text-sm">
            <p className="text-gray-500 text-xs dark:text-slate-400">{`Qty 1`}</p>

            <div className="flex">
              <button
                type="button"
                className="font-medium text-sm text-neutral-800 dark:text-neutral-500 "
              >
                Remove
              </button>
            </div>
    ...
    <Popover className="relative">
      {({ open, close }) => (
        <>
          ...
          >
            <div className="w-4 h-4 flex items-center justify-center  absolute top-1.5 right-1.5 rounded-full text-[10px] bg-black leading-none text-white font-medium">
          ...
          <Transition
            ...
            leavehref="opacity-0 translate-y-10"
          >
            <PopoverPanel className="hidden md:block absolute z-10 w-screen max-w-xs sm:max-w-md px-4 mt-3.5 -right-28 sm:right-0 sm:px-0">
              <div className="overflow-hidden rounded shadow-xl ring-1 ring-black/5 dark:ring-white/10">

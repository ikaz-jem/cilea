...
const NotifyAddTocart = ({
        ...
        <div className="ml-4 flex flex-1 flex-col">
          <div>
            <div className="flex justify-between ">
              ...
              <Prices price={price} className="mt-0.5 text-white" contentClass="text-white" />
            </div>
          </div>
  ...
  return (
    <Transition
      appear
      show={show}
      className="p-4 max-w-md w-full bg-red-500 dark:bg-slate-800 shadow-lg rounded-2xl pointer-events-auto ring-1 ring-black/5 dark:ring-white/10 text-slate-900 dark:text-slate-200"
